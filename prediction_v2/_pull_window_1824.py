# -*- coding: utf-8 -*-
"""拉取 18:00 后 24H 窗口比赛赔率(the-odds-api 逐联赛) -> 追加 snapshots.csv
用法: python prediction_v2/_pull_window_1824.py
窗口: 2026-08-23 18:00 BJT(10:00Z) -> 2026-08-24 18:00 BJT(10:00Z)
"""
import os, sys, io, json, time, urllib.request, collections
