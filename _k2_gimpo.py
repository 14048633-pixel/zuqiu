...
print()
print('='*70)
print('金浦 vs 忠北清州 - 完整流程核心结果')
print('='*70)
s8 = rec['steps'].get('step8', {})
poi = s8.get('poisson', {})
print('泊松λ: 主%s 客%s' % (poi.get('lambda_home'), poi.get('lambda_away')))
print('特征修正:', poi.get('feature_note'))
print('TOP比分:', poi.get('top5_scores'))
s31 = rec['steps'].get('step31_ev_calc', {})
print('best_bet:', s31.get('best_bet'))
print('upset:', rec.get('upset_assessment', {}).get('level'))
