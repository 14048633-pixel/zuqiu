...
url = "https://sports.bzzoiro.com/api/v2/events/?status=upcoming&date_from=2026-08-18&date_to=2026-08-20&limit=3"
req = urllib.request.Request(url, headers={"User-Agent": "Mozilla/5.0", "Authorization": "Token " + tok})
j = json.load(urllib.request.urlopen(req, timeout=30))
res = j.get("results", [])
print(json.dumps(res[0], ensure_ascii=False, indent=1))
